...
static const m4testcompile testcompile_e[] = {
    ...
    {"{: | c :}", {2, {0, m4colon}}, {2, {0, m4colon}}, {2, {m4_locals_enter_x_, T(1)}}},
    {"{: | c d -- e f :}", {2, {0, m4colon}}, {2, {0, m4colon}}, {2, {m4_locals_enter_x_, T(2)}}},
    {"{: a b c | d -- e f g :}",
     {2, {0, m4colon}},
     {2, {0, m4colon}},
     {8, {m4_locals_enter_x_, T(4), m4_to_lx_, T(1), m4_to_lx_, T(2), m4_to_lx_, T(3)}}},
    {"{: a b | c d -- e f g h :} ;",
     {2, {0, m4colon}},
     {},
     {7, {m4_locals_enter_x_, T(4), m4_to_l2_, m4_to_l3_, m4_locals_exit_x_, T(4), m4exit}}},
    /* ------------------------------- 'to' local variables ----------------- */
    {"{: | foo :} 7 to foo ;",
     {2, {0, m4colon}},
     {},
     {7, {m4_locals_enter_x_, T(1), m4seven, m4_to_l0_, m4_locals_exit_x_, T(1), m4exit}}},
    {"{: | bar :} 5 dup to bar ;",
     {2, {0, m4colon}},
     {},
     {7, {m4_locals_enter_x_, T(1), m4five, m4_dup_to_l0_, m4_locals_exit_x_, T(1), m4exit}}},
};
