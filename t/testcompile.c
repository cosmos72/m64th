...
#define COLON_SYS M4FLAG_NOASM, m4colon
...
static const m4testcompile testcompile_c[] = {
    ...
    /* ------------------------------- does> -------------------------------- */
    {"does> ;", {2, {COLON_SYS}}, {}, {3 + nCALLt, {CALL(_does_), m4_does_exit_, m4exit}}},
    {"does> 1+ ;",
     {2, {COLON_SYS}},
     {},
     {4 + nCALLt, {CALL(_does_), m4_does_exit_, m4one_plus, m4exit}}},
    /* ------------------------------- postpone ----------------------------- */
    {"postpone then ;", {2, {COLON_SYS}}, {}, {2 + nCALLt, {CALL(then), m4exit}}},
    {"postpone and ;",
     {2, {COLON_SYS}},
     {},
     {3 + 2 * nCALLt, {m4_lit_xt_, XT(and), CALL(compile_comma), m4exit}}},
    /* ------------------------------- recurse ------------------------------ */
    {"recurse ;", {2, {COLON_SYS}}, {}, {3, {m4_recurse_, T(-2), m4exit}}},
...
static const m4testcompile testcompile_d[] = {
    /* ------------------------------- (optimize-1token) -------------------- */
    {"cell+ ;", {2, {COLON_SYS}}, {}, {2, {m4_SZ_plus, m4exit}}},
    {"cells ;", {2, {COLON_SYS}}, {}, {2, {m4_SZ_times, m4exit}}},
    {"char+ ;", {2, {COLON_SYS}}, {}, {2, {m4one_plus, m4exit}}},
    {"chars ;", {2, {COLON_SYS}}, {}, {1, {m4exit}}},
    {"false ;", {2, {COLON_SYS}}, {}, {2, {m4zero, m4exit}}},
    {"noop ;", {2, {COLON_SYS}}, {}, {1, {m4exit}}},
    {"true ;", {2, {COLON_SYS}}, {}, {2, {m4minus_one, m4exit}}},
    /* ------------------------------- (optimize-2token) -------------------- */
    {"1+ 1- ;", {2, {COLON_SYS}}, {}, {1, {m4exit}}},
    {"1+ 1+ ;", {2, {COLON_SYS}}, {}, {2, {m4two_plus, m4exit}}},
    {"1+ noop 1+ ;", {2, {COLON_SYS}}, {}, {2, {m4two_plus, m4exit}}},
    {"swap drop ;", {2, {COLON_SYS}}, {}, {2, {m4nip, m4exit}}},
    /* ------------------------------- (optimize-2token-lowprio) ------------ */
    {"drop drop ;", {2, {COLON_SYS}}, {}, {2, {m4two_drop, m4exit}}},
    /* ------------------------------- [recompile] -------------------------- */
    /* test [recompile] to correctly update jump offsets after optimization */
    {"if noop 1+ then ;", {2, {COLON_SYS}}, {}, {5, {m4_if_, T(2), m4one_plus, m4then, m4exit}}},
    {"if 1+ 1+ then ;", {2, {COLON_SYS}}, {}, {5, {m4_if_, T(2), m4two_plus, m4then, m4exit}}},
    {"if recurse then ;",
     {2, {COLON_SYS}},
     {},
     {6, {m4_if_, T(3), m4_recurse_, T(-4), m4then, m4exit}}},
    /* ------------------------------- [optimize-3jump] --------------------- */
    {"if then ;", {2, {COLON_SYS}}, {}, {2, {m4drop, m4exit}}},
    {"if chars then ;", {2, {COLON_SYS}}, {}, {2, {m4drop, m4exit}}},
    {"if 1+ 1- then ;", {2, {COLON_SYS}}, {}, {2, {m4drop, m4exit}}},
    {"if else 1 then ;", {2, {COLON_SYS}}, {}, {5, {m4_if0_, T(2), m4one, m4then, m4exit}}},
    {"0= if then ;", {2, {COLON_SYS}}, {}, {2, {m4drop, m4exit}}},
    {"0= if 1 then ;", {2, {COLON_SYS}}, {}, {5, {m4_if0_, T(2), m4one, m4then, m4exit}}},
    {"0= if else 1 then ;", {2, {COLON_SYS}}, {}, {5, {m4_if_, T(2), m4one, m4then, m4exit}}},
    {"dup if then ;", {2, {COLON_SYS}}, {}, {1, {m4exit}}},
    {"dup if dup then ;", {2, {COLON_SYS}}, {}, {2, {m4question_dup, m4exit}}},
    {"dup if noop then ;", {2, {COLON_SYS}}, {}, {1, {m4exit}}},
    {"dup if 1+ 1- then ;", {2, {COLON_SYS}}, {}, {1, {m4exit}}},
    {"dup if 1 then ;", {2, {COLON_SYS}}, {}, {5, {m4_q_if_, T(2), m4one, m4then, m4exit}}},
    {"dup if else 1 then ;", {2, {COLON_SYS}}, {}, {5, {m4_q_if0_, T(2), m4one, m4then, m4exit}}},
    {"dup 0= if 2 then ;", {2, {COLON_SYS}}, {}, {5, {m4_q_if0_, T(2), m4two, m4then, m4exit}}},
    {"dup 0= if else 3 then ;",
     {2, {COLON_SYS}},
     {},
     {5, {m4_q_if_, T(2), m4three, m4then, m4exit}}},
    /* ------------------------------- [optimize] case ---------------------- */
    {"case endcase ;", {2, {COLON_SYS}}, {}, {2, {m4drop, m4exit}}},
    /* ------------------------------- [optimize] begin --------------------- */
    {"begin noop again ;", {2, {COLON_SYS}}, {}, {4, {m4begin, m4_again_, T(-2), m4exit}}},
    ...
    {"begin dup 0= while dup if then repeat ;",
     ...
     {},
     {6, {m4begin, m4_q_while0_, T(2), m4_repeat_, T(-4), m4exit}}},
    {"begin until ;", {2, {COLON_SYS}}, {}, {4, {m4begin, m4_until_, T(-2), m4exit}}},
    {"begin 0= until ;", {2, {COLON_SYS}}, {}, {4, {m4begin, m4_until0_, T(-2), m4exit}}},
    {"begin 0<> until ;", {2, {COLON_SYS}}, {}, {4, {m4begin, m4_until_, T(-2), m4exit}}},
    {"begin dup until ;", {2, {COLON_SYS}}, {}, {4, {m4begin, m4_q_until_, T(-2), m4exit}}},
    {"begin dup 0= until ;", {2, {COLON_SYS}}, {}, {4, {m4begin, m4_q_until0_, T(-2), m4exit}}},
    /* ------------------------------- [optimize] --------------------------- */
    {"dup dup dup dup drop drop drop drop ;", {2, {COLON_SYS}}, {}, {1, {m4exit}}},
    {"drop dup dup dup drop drop drop drop ;", {2, {COLON_SYS}}, {}, {2, {m4two_drop, m4exit}}},
};

static const m4testcompile testcompile_e[] = {
    /* ------------------------------- local variables ---------------------- */
    {"{: :}", {2, {COLON_SYS}}, {2, {COLON_SYS}}, {/* optimized away */}},
    {"{: :} ;", {2, {COLON_SYS}}, {}, {1, {/* optimized away */ m4exit}}},
    {"{: -- a b c :}", {2, {COLON_SYS}}, {2, {COLON_SYS}}, {/* optimized away */}},
    {"{: a :}", {2, {COLON_SYS}}, {2, {COLON_SYS}}, {4, {m4_lenter_x_, T(1), m4_to_lx_, T(0)}}},
    {"{: | c :}", {2, {COLON_SYS}}, {2, {COLON_SYS}}, {2, {m4_lenter_x_, T(1)}}},
    {"{: | c d -- e f :}", {2, {COLON_SYS}}, {2, {COLON_SYS}}, {2, {m4_lenter_x_, T(2)}}},
    {"{: a b c | d -- e f g :}",
     {2, {COLON_SYS}},
     {2, {COLON_SYS}},
