...
static const m4testcompile testcompile_a[] = {
    ...
    {"case", {}, {2, {2, m4_case_}}, {2, {m4_case_, T(-1)}}},
    {"case 1 of", {}, {4, {2, m4_case_, 5, m4_of_}}, {5, {m4_case_, T(-1), m4one, m4_of_, T(-1)}}},
    {"case 1 of 2 endof",
     {},
     {4, {2, m4_case_, 8, m4_endof_}},
     {8, {m4_case_, T(-1), m4one, m4_of_, T(3), m4two, m4_endof_, T(-1)}}},
    {"case 2 of 3 endof 4 of 5 endof",
     {},
     {6, {2, m4_case_, 8, m4_endof_, 14, m4_endof_}},
     {14,
    ...
    {"case 3 of 4 endof 5 of 6 endof 7 endcase",
     ...
     {},
     {16,
      {m4_case_, T(-1), m4three, m4_of_, T(3), m4four, m4_endof_, T(8), m4five, m4_of_, T(3), m4six,
