...
static m6testasm testasm_a[] = {
    ...
    {"1+ (asm/recurse)",
     {CALL(token_to_asm), m6asm_bytes_comma, CALL(_asm_recurse_), m6bye},
     {1, {m6one_plus}},
     {},
     {(const m6char *)"\224\006\000\221\376\216\037\370\376\377\377\227\376\206@\370", 16}},
    {"[asm-lit-n,]",
    ...
    {"1+ (asm/recurse)",
     ...
     {1, {m6one_plus}},
     {},
     {(const m6char *)"H\377\300\350\370\377\377\377", 8}},
#endif
};
