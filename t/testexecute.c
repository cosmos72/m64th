...
static m4testexecute testexecute_d[] = {
    ...
    /* ----------------------------- locals --------------------------------- */
    {"(locals-enter-x)",
     {m4_locals_enter_x_, T(3), m4rdepth, m4two_r_from_two_drop, m4two_r_from_two_drop, m4bye},
     {{}, {}},
     {{1, {4 /* rdepth*/}}, {}},
     {}},
    {"(locals-exit-x)",
     {m4_locals_exit_x_, T(3), m4bye},
     {{}, {4, {12, 11, 10 /*saved l2,l1,l0*/, 0 /*previous LOCL*/}}},
     {},
     {}},
    {"(lx)",
     {m4_locals_enter_x_, T(2), m4_to_l0_, m4_to_l1_, m4_l0_, m4_l1_, m4minus, m4_locals_exit_x_,
      T(2), m4bye},
     {{2, {8, 3}}, {}},
     {{1, {-5}}, {}},
     {}},
    ...
    {"0 1 [compile-locals-enter]",
     ...
     {{2, {0, 1}}, {}},
     {{}, {}},
     {2, {m4_locals_enter_x_, T(1)}}},
    {"1 0 [compile-locals-enter]",
     {CALL(_compile_locals_enter_), m4bye},
     {{2, {1, 0}}, {}},
     {{}, {}},
     {4, {m4_locals_enter_x_, T(1), m4_to_lx_, T(0)}}},
    {"2 3 [compile-locals-enter]",
     {CALL(_compile_locals_enter_), m4bye},
     {{2, {2, 3}}, {}},
     {{}, {}},
     {6, {m4_locals_enter_x_, T(5), m4_to_lx_, T(3), m4_to_lx_, T(4)}}},
};
