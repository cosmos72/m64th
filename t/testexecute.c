...
static m4testexecute testexecute_b[] = {
    ...
    /* ----------------------------- local ---------------------------------- */
    {"(local-enter)",
     {m4_local_enter_, T(3), m4_to_local_0_, m4_to_local_1_, m4_to_local_2_, m4bye},
     {{3, {7, 8, 9}}, {}},
     {{}, {5, {0, 7, 8, 9, 3}}},
     {}},
    {"(local-exit)", {m4_local_exit_, T(3), m4bye}, {{}, {3, {99, 11, 1}}}, {}, {}},
    {"locals",
     {m4_local_enter_, T(2), m4_to_local_0_, m4_to_local_1_, m4_local_0_, m4_local_1_, m4minus,
      m4_local_exit_, m4bye},
     {{2, {8, 3}}, {}},
     {{1, {-5}}, {}},
     {}},
};
