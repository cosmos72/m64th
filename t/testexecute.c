...
static m4testexecute testexecute_d[] = {
    ...
    /* ----------------------------- locals --------------------------------- */
    {"(locals-enter)",
     {m4_locals_enter_, T(3), m4_to_l0_, m4_to_l1_, m4_to_l2_, m4bye},
     {{3, {7, 8, 9}}, {}},
     {{}, {5, {0 /*previous LOCL*/, 7, 8, 9 /*saved l2,l1,l0*/, 3}}},
     {}},
    {"(locals-exit)",
     {m4_locals_exit_, T(3), m4bye},
     {{}, {3, {0 /*previous LOCL*/, 11 /*saved l0*/, 1}}},
     {},
     {}},
    {"(lx)",
     {m4_locals_enter_, T(2), m4_to_l0_, m4_to_l1_, m4_l0_, m4_l1_, m4minus, m4_locals_exit_,
      m4bye},
     {{2, {8, 3}}, {}},
     {{1, {-5}}, {}},
     {}},
    ...
    {"2 3 [compile-locals-enter]",
     ...
     {{2, {2, 3}}, {}},
     {{}, {}},
     {6, {m4_locals_enter_, T(5), m4_to_lx_, T(3), m4_to_lx_, T(4)}}},
};
