...
static m4testexecute testexecute_c[] = {
    ...
    {"iobuf-refill",
     ...
     {}},
    {"iobuf-read-blanks",
     {m4in_to_ibuf, CALL(ibuf_read_blanks), m4bye},
     {{}, {}},
     {{1, {m4err_unexpected_eof}}, {}},
     {}},
    {"iobuf-read-nonblanks",
     {m4in_to_ibuf, CALL(ibuf_read_nonblanks), m4zero_equal, m4swap, m4in_to_ibuf, m4iobuf_addr,
      m4equal, m4bye},
     {{}, {}},
     {{2, {ttrue, ttrue}}, {}},
     {}},
...
static m4testexecute testexecute_f[] = {
    ...
    {"name>prev",
     ...
     {}},
    {"name>", {m4name_to, m4bye}, {{1, {(m4cell)&WORD_SYM(dup)}}, {}}, {{1, {DXT(dup)}}, {}}, {}},
    {"wordlist-last",
