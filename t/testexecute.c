...
static m4testexecute testexecute_a[] = {
    ...
    {"1e6 0 do wordlist-find loop",
     {m4do, m4j, CALL(wordlist_find), m4_loop_, T(-4 - nCALLt), m4bye},
     {{4, {(m4cell) "dup", 3, 1e6, 0}}, {1, {(m4cell)&m4wordlist_forth}}},
     {{2, {(m4cell) "dup", 3}}, {1, {(m4cell)&m4wordlist_forth}}},
     {}},
#elif 0
    {"1e8 0 do over crc+ loop nip",
     {m4do, m4over, m4_call_, CELL(crc1byte_code), m4_loop_, T(-4 - nCALLt), m4nip, m4bye},
    ...
    {"2tuck", {m4two_tuck, m4bye}, {{4, {1, 2, 3, 4}}, {}}, {{6, {3, 4, 1, 2, 3, 4}}, {}}, {}},
    {"3", {m4three, m4bye}, {{}, {}}, {{1, {3}}, {}}, {}},
    {"4", {m4four, m4bye}, {{}, {}}, {{1, {4}}, {}}, {}},
...
static m4testexecute testexecute_b[] = {
    ...
    {"u /string",
     ...
     {}},
    /*                                                                          */
    {"-261 >byte", {m4to_byte, m4bye}, {{1, {-261}}, {}}, {{1, {(int8_t)-261}}, {}}, {}},
    {"-128 >byte", {m4to_byte, m4bye}, {{1, {-128}}, {}}, {{1, {-128}}, {}}, {}},
    {"127 >byte", {m4to_byte, m4bye}, {{1, {127}}, {}}, {{1, {127}}, {}}, {}},
    {"259 >byte", {m4to_byte, m4bye}, {{1, {259}}, {}}, {{1, {(int8_t)259}}, {}}, {}},
    {"-261 >char", {m4to_char, m4bye}, {{1, {-261}}, {}}, {{1, {(uint8_t)-261}}, {}}, {}},
    {"-7 >char", {m4to_char, m4bye}, {{1, {-7}}, {}}, {{1, {(uint8_t)-7}}, {}}, {}},
    {"0 >char", {m4to_char, m4bye}, {{1, {0}}, {}}, {{1, {0}}, {}}, {}},
    {"255 >char", {m4to_char, m4bye}, {{1, {255}}, {}}, {{1, {255}}, {}}, {}},
    {"259 >char", {m4to_char, m4bye}, {{1, {259}}, {}}, {{1, {(uint8_t)259}}, {}}, {}},
    {"-54321 >short", {m4to_short, m4bye}, {{1, {-54321}}, {}}, {{1, {(int16_t)-54321}}, {}}, {}},
    {"-32768 >short", {m4to_short, m4bye}, {{1, {-32768}}, {}}, {{1, {-32768}}, {}}, {}},
    {"32767 >short", {m4to_short, m4bye}, {{1, {32767}}, {}}, {{1, {32767}}, {}}, {}},
    {"54321 >short", {m4to_short, m4bye}, {{1, {54321}}, {}}, {{1, {(int16_t)54321}}, {}}, {}},
    {"-76543 >ushort",
     {m4to_ushort, m4bye},
     {{1, {-76543}}, {}},
     {{1, {(uint16_t)-76543}}, {}},
     {}},
    {"-11 >ushort", {m4to_ushort, m4bye}, {{1, {-11}}, {}}, {{1, {(uint16_t)-11}}, {}}, {}},
    {"0 >ushort", {m4to_ushort, m4bye}, {{1, {0}}, {}}, {{1, {0}}, {}}, {}},
    {"65535 >ushort", {m4to_ushort, m4bye}, {{1, {65535}}, {}}, {{1, {65535}}, {}}, {}},
    {"76543 >ushort", {m4to_ushort, m4bye}, {{1, {76543}}, {}}, {{1, {(uint16_t)76543}}, {}}, {}},
    {"-9876543210 >int",
     {m4to_int, m4bye},
     {{1, {-9876543210l}}, {}},
    ...
    {"-9876543210 >uint",
     ...
     {}},
    {"-76543 >uint", {m4to_uint, m4bye}, {{1, {-76543}}, {}}, {{1, {(uint32_t)-76543}}, {}}, {}},
    {"0 >uint", {m4to_uint, m4bye}, {{1, {0}}, {}}, {{1, {0}}, {}}, {}},
    {"65536 >uint", {m4to_uint, m4bye}, {{1, {65536}}, {}}, {{1, {65536}}, {}}, {}},
    {"4294967295 >uint",
     {m4to_uint, m4bye},
     {{1, {4294967295u}}, {}},
     {{1, {4294967295u}}, {}},
...
static m4testexecute testexecute_c[] = {
    ...
    {"1 case 1 (of) T(3) -1 (endof) T(3) 2* 0 endcase",
     {m4case, m4one, m4_of_, T(3), m4minus_one, m4_endof_, T(3), m4two_times, m4zero, m4endcase,
      m4bye},
     {{1, {1}}, {}},
     {{1, {-1}}, {}},
     {}},
...
static m4testexecute testexecute_d[] = {
    ...
    /* ----------------------------- locals --------------------------------- */
    {"(lenter-x)",
     {m4_lenter_x_, T(3), m4rdepth, m4two_r_from_two_drop, m4two_r_from_two_drop, m4bye},
     {{}, {}},
     {{1, {4 /* rdepth*/}}, {}},
     {}},
    {"(lexit-x)",
     {m4_lexit_x_, T(3), m4bye},
     {{}, {4, {12, 11, 10 /*saved l2,l1,l0*/, 0 /*previous LOCL*/}}},
     {},
     {}},
    {"(lx)",
     {m4_lenter_x_, T(2), m4_to_l0_, m4_to_l1_, m4_l0_, m4_l1_, m4minus, m4_lexit_x_, T(2), m4bye},
     {{2, {8, 3}}, {}},
     {{1, {-5}}, {}},
     {}},
    {"(user-locals-allocate)",
     {CALL(_user_locals_allocate_), m4cell_fetch_2, m4bye},
     {{}, {}},
     {{1, {sizeof(m4locals) + 16 * (sizeof(m4local) + 255)}}, {}},
     {}},
    {"_ (local)",
     {CALL(_local_), m4user_var, T(M4TH_USER_VAR_LOCALS), m4fetch, m4dup, m4fetch, m4swap,
      m4cell_fetch_1, m4bye},
     {{2, {(m4cell) "ab3", 3}}, {}},
     {{2, {1 /*ls.n*/, 5 /*ls.end*/}}, {}},
     {}},
    {"_ string>local",
     {CALL(_local_), CALL(_user_locals_set_idx_), CALL(string_to_local), m4bye},
     {{4, {(m4cell) "cd67", 4, (m4cell) "cd67", 3}}, {}},
     {{2, {-1, tfalse}}, {}},
     {}},
    {"s\" cd67\" string>local",
     {CALL(_local_), CALL(_user_locals_set_idx_), CALL(string_to_local), m4bye},
     {{4, {(m4cell) "cd67", 4, (m4cell) "cd67", 4}}, {}},
     {{2, {0, ttrue}}, {}},
     {}},
    {"0 0 [compile-lenter]",
     {CALL(_compile_lenter_), m4bye},
     {{2, {0, 0}}, {}},
     {{}, {}},
     {}}, /* optimized away */
    {"0 1 [compile-lenter]",
    ...
    {"1 0 [compile-lenter]",
     ...
     {{2, {1, 0}}, {}},
     {{}, {}},
     {4, {m4_lenter_x_, T(1), m4_to_lx_, T(0)}}},
    {"2 3 [compile-lenter]",
     {CALL(_compile_lenter_), m4bye},
     {{2, {2, 3}}, {}},
     {{}, {}},
     {6, {m4_lenter_x_, T(5), m4_to_lx_, T(3), m4_to_lx_, T(4)}}},
};
...
static m4testexecute testexecute_f[] = {
    ...
    {"cmove \\ with copy propagation",
     ...
     {}},
    {"-cmove/count",
     {m4sp_fetch, m4dup, m4one_plus, m4cell_plus, m4swap, m4two, m4minus_cmove_count, m4two_drop,
      m4bye},
     {{2, {'a' | 'b' << 8 | 'c' << 16 | 'd' << 24, 0}}, {}},
     {{2, {'a' | 'b' << 8 | 'c' << 16 | 'd' << 24, 'b' | 'c' << 8}}, {}},
     {}},
    {"-cmove/count \\ with copy propagation",
     {m4sp_fetch, m4dup, m4one_plus, m4swap, m4two, m4minus_cmove_count, m4two_drop, m4bye},
     {{1, {'w' | 'x' << 8 | 'y' << 16 | 'z' << 24}}, {}},
     {{1, {'y' | 'y' << 8 | 'y' << 16 | 'z' << 24}}, {}},
     {}},
    {"move",
...
#undef P
    ...
    /* ----------------------------- token ---------------------------------- */
    {"token>asm>addr",
     {m4token_to_asm_addr, m4bye},
     {{1, {m4dup}}, {}},
     {{1, {(m4cell)m4fdup}}, {}},
     {}},
    {"token>asm>n", {CALL(token_to_asm_n), m4bye}, {{1, {m4noop}}, {}}, {{2, {0, ttrue}}, {}}, {}},
    {"token>name",
    ...
    /* ----------------------------- name ----------------------------------- */
    {"' noop name>asm>n",
     {m4name_to_asm_n, m4bye},
     {{1, {(m4cell)&WORD_SYM(noop)}}, {}},
     {{2, {0, ttrue}}, {}},
     {}},
    {"' repl name>asm>n",
     {m4name_to_asm_n, m4bye},
     {{1, {(m4cell)&WORD_SYM(repl)}}, {}},
     {{2, {0, tfalse}}, {}},
     {}},
    {"name>flags",
    ...
    /* ----------------------------- xt ------------------------------------- */
    {"{1 exit} xt>asm>n",
     {m4token_comma, m4token_comma, CALL(xt_to_asm_n), m4nip, m4bye},
     {{2, {m4exit, m4one}}, {}},
     {{1, {ttrue}}, {}},
     {2, {m4one, m4exit}}},
    {"{(ip>data) exit} xt>asm>n",
     {m4token_comma, m4token_comma, CALL(xt_to_asm_n), m4nip, m4bye},
     {{2, {m4exit, m4_ip_to_data_}}, {}},
     {{1, {tfalse}}, {}},
     {2, {m4_ip_to_data_, m4exit}}},
    /* ----------------------------- wordlist ------------------------------- */
    {"wordlist>last",
