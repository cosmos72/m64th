...
static const m4testio testio_a[] = {
    ...
    {"ibuf-skip-blanks",
     ...
     {"# ", ""}},
    {"\" \" ibuf-skip-blanks-except-cr",
     {m4in_to_ibuf, CALL(ibuf_skip_blanks_except_cr), m4bye},
     {{}, {}},
     {{1, {tfalse}}, {}},
     {" ", ""},
     {"", ""}},
    ...
    {"\"... # \" ibuf-skip-blanks-until-cr",
     ...
     {" # ", ""}},
    {"'\"' ibuf-delimited-line",
     {m4in_to_ibuf, m4swap, CALL(ibuf_delimited_line), m4type, m4bye},
     {{1, {'"'}}, {}},
     {{}, {}},
     {" foo\"x", ""},
     {"x", " foo"}},
    {"'z' ibuf-delimited-line",
     {m4in_to_ibuf, m4swap, CALL(ibuf_delimited_line), m4type, m4bye},
     {{1, {'z'}}, {}},
     {{}, {}},
     {"  x y \n", ""},
