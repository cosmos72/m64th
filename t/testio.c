...
static const m4testio testio_b[] = {
    ...
    {"<# char b char c hold #>",
     ...
     {"", "cb"}},
    {"<# _ holds #>",
     {m4num_start, m4holds, m4num_end, m4type, m4bye},
     {{4, {0, 0, (m4cell) "fubar", 5}}, {}},
     {{}, {}},
     {"", ""},
     {"", "fubar"}},
    {"<# 3 # #>",
...
static const m4testio testio_c[] = {
    /* ------------------------- dot ---------------------------------------- */
    {"12348 .", {CALL(dot), m4bye}, {{1, {12348}}, {}}, {{}, {}}, {"", ""}, {"", "12348 "}},
    {"-97003 .", {CALL(dot), m4bye}, {{1, {-97003}}, {}}, {{}, {}}, {"", ""}, {"", "-97003 "}},
#if SZ == 4
    /* ------------------------- u_dot -------------------------------------- */
    {"-1 u.", {CALL(u_dot), m4bye}, {{1, {-1}}, {}}, {{}, {}}, {"", ""}, {"", "4294967295 "}},
#elif SZ == 8
    {"-1 u.",
     {CALL(u_dot), m4bye},
     {{1, {-1}}, {}},
