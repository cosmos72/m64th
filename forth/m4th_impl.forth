...
: (optimize-tokens)    \ ( tok-addr u -- counted-tokens u' | 0 0 )
   ...
   begin                                       \ ( &data                 ) (R: tok-addr u )
      dup cell+ byte@ dup                      \ ( &data n n             ) (R: tok-addr u )
   while                \ *-                   \ ( &data n               ) (R: tok-addr u )
      r@ u<=            \   \                  \ ( &data t|f             ) (R: tok-addr u )
   while                \ *  \                 \ ( &data                 ) (R: tok-addr u )
      r2nd@ over @      \  \  \                \ ( &data tok-addr xt     ) (R: tok-addr u )
      execute           \   \  \               \ ( &data cnt-tokens|0    ) (R: tok-addr u )
      dup               \   |  |               \ ( &data cnt-tokens|0 t|f) (R: tok-addr u )
   until                \   |  |               \ ( &data cnt-tokens      ) (R: tok-addr u )
      swap cell+ byte@  \   |  |               \ ( cnt-tokens n          ) (R: tok-addr u )
      2r> 2drop exit    \   |  |               \ ( cnt-tokens n          )
   then                 \  /  /                \ ( &data                 ) (R: tok-addr u )
      0                 \ *  /                 \ ( &data _               ) (R: tok-addr u )
   then                 \   /                  \ ( &data _               ) (R: tok-addr u )
   2drop 0 0            \ *-                   \ ( 0 0                   ) (R: tok-addr u )
   2r> 2drop                                   \ ( 0 0                   )
;
